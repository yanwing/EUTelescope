...
#ifndef EUTelProcessorAnnulusClustering_H
#define EUTelProcessorAnnulusClustering_H 1
...
class EUTelProcessorAnnulusClustering :public marlin::Processor , public marlin::EventModifier {

public:

    //! Returns a new instance of EUTelProcessorAnnulusClustering
    /*! This method returns an new instance of the this processor.  It
     *  is called by Marlin execution framework and it shouldn't be
     *  called/used by the final user.
     *
     *  @return a new EUTelProcessorAnnulusClustering.
     */
    virtual Processor* newProcessor() {
		return new EUTelProcessorAnnulusClustering;
    }

    virtual const std::string & name() const { return Processor::name(); }

    //! Default constructor
    EUTelProcessorAnnulusClustering ();
     ...
     *  algorithm.
     *
     *  @see EUTelProcessorAnnulusClustering::fixedFrameClustering(LCEvent *)
     *
...
private:
	DISALLOW_COPY_AND_ASSIGN(EUTelProcessorAnnulusClustering)
...
EUTelProcessorAnnulusClustering gEUTelProcessorAnnulusClustering;
}
#endif
