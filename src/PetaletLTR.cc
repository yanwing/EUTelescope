...
PetaletLTR::PetaletLTR(): EUTelGenericPixGeoDescr(45.0, 45.0, 1.0,	//size X, Y, Z (21.2, 10.6, 0.02)
...
void  PetaletLTR::createRootDescr(char const * planeVolume)
{
...
std::string PetaletLTR::getPixName(int x , int y)
{
	char buffer [100];
...
{
	PetaletLTR* mPixGeoDescr = new PetaletLTR();
